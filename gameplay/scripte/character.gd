...
var vote_menu = preload("res://gameplay/scripte_ablauf/voting.gd").new()
...
func switch_child(player_list, my_data):
	...
	player_lists = await vote_menu.start_voting(player_list, my_data.mayor, 60)
...
func werewolfs(player_list, my_data):
	...
	player_lists = await vote_menu.start_voting(player_list, my_data.mayor, 180)
...
func mayor(player_list, my_data):
	...
	if voten:
		...
		player_lists = await vote_menu.start_voting(player_list, my_data.mayor, 300)
